...
func main() {
	...
	err = platform.SetMellanoxRegKeyPriorityVLANTag()
	if err != nil {
		logger.Errorf("Failed to set reg key for mellanox adapter: %v", err)
	} else {
		logger.Printf("Successfuly set reg key for existing Mellanox adapter.")
	}
